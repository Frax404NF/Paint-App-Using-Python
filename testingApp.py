...
tool_frame.place(x=445, y=10, width=190, height=70)
...
#Tool_Button
canvas_color_b1 = Button(tool_frame, text="Canvas")
canvas_color_b1.grid(row = 0, column = 0)

save_b2 = Button(tool_frame, text="Save")
save_b2.grid(row = 0, column = 1 )

eraser_b3 = Button(tool_frame, text="Eraser")
eraser_b3.grid(row = 0, column = 2)

clear_b4 = Button(tool_frame, text="Clear")
